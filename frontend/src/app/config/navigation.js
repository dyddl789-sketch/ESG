...
export const NAVIGATION = Object.freeze({
  [ROLES.COMPANY_MANAGER]: [
    { label: "개요", items: [
      { to: "/manager/dashboard", icon: "dashboard", label: "ESG 관리자 대시보드" },
    ]},
    { label: "데이터 관리", items: [
  ...
  [ROLES.SYSTEM_ADMIN]: [
    { label: "시스템 개요", items: [
      { to: "/admin/dashboard", icon: "dashboard", label: "시스템 대시보드" },
      { to: "/admin/approvals", icon: "approval", label: "최종 승인 관리", badgeKey: "pendingApprovals" },
    ]},
    { label: "플랫폼 관리", items: [
    ...
    { label: "운영 관리", items: [
      { to: "/admin/integrations", icon: "sync", label: "연동 모니터링" },
      { to: "/admin/audit", icon: "audit", label: "감사 로그" },
    ]},
  ],
  [ROLES.EXTERNAL_USER]: [
    { label: "공개 정보", items: [
      { to: "/public/dashboard", icon: "dashboard", label: "공개 ESG 대시보드" },
